...
# If you don't have wget, you can replace these with the commented lines below
...
# curl --output-dir data/raw/wind/3dp/3dp_elm2/2016/ --create-dirs -O \
#   "https://spdf.gsfc.nasa.gov/pub/data/wind/3dp/3dp_elm2/2016/wi_elm2_3dp_201601[01-07]_v02.cdf"
...
curl --output-dir data/raw/wind/3dp/3dp_pm/2016/ --create-dirs -O \
  "https://spdf.gsfc.nasa.gov/pub/data/wind/3dp/3dp_pm/2016/wi_pm_3dp_201601[01-07]_v05.cdf"
